...
namespace IIS.NiFiSample
{
    ...
    public class SparePart : ICSSoft.STORMNET.DataObject, IDataObjectWithAuditFields
    {
        ...
        private IIS.NiFiSample.ProducingCountry fProducingCountry;
        
        private IIS.NiFiSample.Car fCar;
        ...
        public virtual IIS.NiFiSample.ProducingCountry ProducingCountry
        {
            get
            {
                ...
                IIS.NiFiSample.ProducingCountry result = this.fProducingCountry;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.NiFiSample.Car.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual IIS.NiFiSample.Car Car
        {
            get
            {
                ...
                IIS.NiFiSample.Car result = this.fCar;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View AuditView
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("AuditView", typeof(IIS.NiFiSample.SparePart));
                }
            }
            ...
            public static ICSSoft.STORMNET.View SparePartE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("SparePartE", typeof(IIS.NiFiSample.SparePart));
                }
            }
        }
    ...
    public class DetailArrayOfSparePart : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.NiFiSample.DetailArrayOfSparePart members)

        // *** End programmer edit section *** (IIS.NiFiSample.DetailArrayOfSparePart members)
        ...
        /// </summary>
        public DetailArrayOfSparePart(IIS.NiFiSample.Car fCar) : 
                base(typeof(SparePart), ((ICSSoft.STORMNET.DataObject)(fCar)))
        {
        }
        
        public IIS.NiFiSample.SparePart this[int index]
        {
            get
            {
                return ((IIS.NiFiSample.SparePart)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.NiFiSample.SparePart dataobject)
        {
